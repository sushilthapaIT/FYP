			...
			<div class=" main-content-area">
				...
				<div class="summary summary-checkout">
					...
					<div class="summary-item shipping-method">
						...
						<p class="summary-info"><span class="title">Fixed NPR 50.00</span></p>
						...
						<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									<a href="#" title="BAKERY ITEM">
										<figure><img src="{{('assets/images/products/c1.jpg')}}" width="214" height="214" alt="BAKERY ITEM"></figure>
									</a>
									<div class="wrap-btn">
								...
								<div class="product-info">
									...
									<div class="wrap-price"><ins><p class="product-price">NPR 168.00</p></ins> <del><p class="product-price">$250.00</p></del></div>
								</div>
							</div>
